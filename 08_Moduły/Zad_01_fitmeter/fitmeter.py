...
# użytkownika o jego aktualnym BMI i na podstawie wyniku (niedowaga, nadwaga, otyłość)
# sugerował zmiany w stylu życia pobierane z odpowiedniego pliku.
#
#     Utwórz plik bmi.py zawierający metodę obliczania bmi. Metoda zwraca wartości:
