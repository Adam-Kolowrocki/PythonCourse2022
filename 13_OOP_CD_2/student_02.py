# Zadanie
# utwórz atrybut, będący właściwością (property), generujący username systemu studenckiego,
# jest to imię, 3 litery nazwiska, i 6 losowych liczb
# pozwól utworzyć setter modyfikujący na tej bazie imię i a wiek ustawia na podstawie
# sumy 6 cyfr z username podzielonych przez 2
