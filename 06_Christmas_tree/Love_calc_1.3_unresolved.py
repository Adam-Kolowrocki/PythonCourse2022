...
def love_percent():
    ...
    while len(love_calc(love_number)) > 2:
        love_calc(love_number)
        love = love_calc(love_number)
    return love


def love_calc(love_number):
    # love_number = love_str_num()
    cycle = 0
    new_love_number = ""
...
def main():
    love_result = love_percent()
    print(f'Macie {love_result}% szansy na udaną miłość...')
